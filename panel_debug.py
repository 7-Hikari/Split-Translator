...
def buat_panel_debug(root):
    debug_frame = tk.LabelFrame(root, text=" Jendela Debug Console (System Log) ", bg="#2f3640", fg="#f5f6fa", font=("Arial", 12, "bold"), padx=5, pady=5)
    ...
    debug_text_widget = tk.Text(debug_frame, height=6, bg="#1e2124", fg="#00ff00", font=("Consolas", 12), yscrollcommand=debug_scrollbar.set, state=tk.DISABLED)
